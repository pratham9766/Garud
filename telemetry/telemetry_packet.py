...
def build_telemetry_packet(snap: PayloadSnapshot) -> str:
    ...
    packet = {
        ...
        "gps": snap.gps_ok,
        "nq": snap.navigation_mode,
        "nlat": round(snap.estimated_latitude, 6),
        "nlon": round(snap.estimated_longitude, 6),
        "nalt": round(snap.estimated_altitude_m, 1),
        "nhdg": round(snap.estimated_heading_deg, 1),
        "ncog": round(snap.estimated_course_deg, 1),
        "ngs": round(snap.estimated_ground_speed_mps, 1),
        "ngps": snap.nav_gps_valid,
        "safe": snap.safe_for_guidance,
        "cam": snap.camera_ok,
        "imu": snap.imu_ok,
